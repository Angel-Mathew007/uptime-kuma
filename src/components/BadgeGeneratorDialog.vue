        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div
                        v-if="
                            (parameters[badge.type || 'null'] || []).includes(
                                'duration',
                            )
                        "
                        class="mb-3"
                    ...
                    <div
                        ...
                        class="mb-3"
                    >
                        <label for="labelColor" class="form-label">{{
                            $t("Badge Label Color")
                        }}</label>
                        <input
                            id="labelColor"
                    ...
                    <div
                        ...
                        class="mb-3"
                    >
                        <label for="labelPrefix" class="form-label">{{
                            $t("Badge Label Prefix")
                        }}</label>
                        <input
                            id="labelPrefix"
                            v-model="badge.labelPrefix"
                            type="text"
                            class="form-control"
                        />
                    </div>
                    ...
                    <div
                        ...
                        class="mb-3"
                    >
                        <label for="labelSuffix" class="form-label">{{
                            $t("Badge Label Suffix")
                        }}</label>
                        <input
                            id="labelSuffix"
                    ...
                    <div
                        ...
                        class="mb-3"
                    >
                        <label for="upColor" class="form-label">{{
                            $t("Badge Up Color")
                        }}</label>
                        <input
                            id="upColor"
                    ...
                    <div
                        ...
                        class="mb-3"
                    >
                        <label for="downColor" class="form-label">{{
                            $t("Badge Down Color")
                        }}</label>
                        <input
                            id="downColor"
                    ...
                    <div
                        ...
                        class="mb-3"
                    >
                        <label for="pendingColor" class="form-label">{{
                            $t("Badge Pending Color")
                        }}</label>
                        <input
                            id="pendingColor"
                    ...
                    <div
                        ...
                        class="mb-3"
                    >
                        <label for="maintenanceColor" class="form-label">{{
                            $t("Badge Maintenance Color")
                        }}</label>
                        <input
                            id="maintenanceColor"
                            ...
                            class="form-control"
                            :placeholder="
                                badgeConstants.defaultMaintenanceColor
                            "
                        />
                    </div>
                    ...
                    <div
                        ...
                        class="mb-3"
                    >
                        <label for="warnColor" class="form-label">{{
                            $t("Badge Warn Color")
                        }}</label>
                        <input
                            id="warnColor"
                    ...
                    <div
                        ...
                        class="mb-3"
                    >
                        <label for="warnDays" class="form-label">{{
                            $t("Badge Warn Days")
                        }}</label>
                        <input
                            id="warnDays"
                            ...
                            class="form-control"
                            :placeholder="
                                badgeConstants.defaultCertExpireWarnDays
                            "
                        />
                    </div>
                    ...
                    <div
                        ...
                        class="mb-3"
                    >
                        <label for="downDays" class="form-label">{{
                            $t("Badge Down Days")
                        }}</label>
                        <input
                            id="downDays"
                            ...
                            class="form-control"
                            :placeholder="
                                badgeConstants.defaultCertExpireDownDays
                            "
                        />
                    </div>
                    ...
                    <div class="mb-3">
                        <label for="value" class="form-label">{{
                            $t("Badge value (For Testing only.)")
                        }}</label>
                        <input
                            id="value"
                            v-model="badge.value"
                    ...
                    <div class="my-3">
                        <label for="badge-url" class="form-label">{{
                            $t("Badge URL")
                        }}</label>
                        <CopyableInput
                            id="badge-url"
