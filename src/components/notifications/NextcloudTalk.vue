<template>
    <div class="mb-3">
        <div class="mb-3">
            ...
            <input
                id="nextcloud-host"
                v-model="$parent.notification.host"
                type="text"
                class="form-control"
            />
        </div>
        ...
        <div class="mb-3">
            <div class="form-check form-switch">
                <input
                    v-model="$parent.notification.sendSilentUp"
        ...
        <div class="mb-3">
            <div class="form-check form-switch">
                <input
                    v-model="$parent.notification.sendSilentDown"
                    class="form-check-input"
                    type="checkbox"
                />
                <label class="form-check-label">{{
                    $t("Send DOWN silently")
                }}</label>
            </div>
        </div>
        ...
        <div class="mb-3">
            <div class="form-text">
                <p>
                    {{
                        $t(
                            "Installing a Nextcloud Talk bot requires administrative access to the server.",
                        )
                    }}
                </p>
                <p>{{ $t("Example:") }}</p>
...
occ talk:bot:setup &lt;BotId&gt; &lt;ConversationToken&gt;
                ...
                <i18n-t tag="p" keypath="Read more:">
                    <a
                        href="https://nextcloud-talk.readthedocs.io/en/latest/bot-list/#uptime-kuma"
                        target="_blank"
                        >https://nextcloud-talk.readthedocs.io</a
                    >
                </i18n-t>
            </div>
        </div>
