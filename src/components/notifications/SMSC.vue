<template>
    <div class="mb-3">
        <label for="smsc-login" class="form-label">{{
            $t("API Username")
        }}</label>
        ...
        <input
            id="smsc-login"
            v-model="$parent.notification.smscLogin"
            type="text"
            class="form-control"
            required
        />
    ...
    <div class="mb-3">
        <div class="form-text">
            {{ $t("checkPrice", ["СМСЦ"]) }}
            <a href="https://smsc.kz/tariffs/" target="_blank"
                >https://smsc.kz/tariffs/</a
            >
        </div>
    </div>
    <div class="mb-3">
        <label for="smsc-to-number" class="form-label">{{
            $t("Recipient Number")
        }}</label>
        <input
            id="smsc-to-number"
    ...
    <div class="mb-3">
        <label for="smsc-sender-name" class="form-label">{{
            $t("From Name/Number")
        }}</label>
        <input
            id="smsc-sender-name"
        ...
        />
        <div class="form-text">
            {{ $t("Leave blank to use a shared sender number.") }}
        </div>
    </div>
    <div class="mb-3">
        <label for="smsc-platform" class="form-label">{{
            $t("smscTranslit")
        }}</label
        ><span style="color: red"><sup>*</sup></span>
        <select
            id="smsc-platform"
            v-model="$parent.notification.smscTranslit"
            class="form-select"
        >
