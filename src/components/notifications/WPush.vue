<template>
    <div class="mb-3">
        <label for="wpush-apikey" class="form-label"
            >WPush {{ $t("API Key") }}</label
        >
        <HiddenInput
            id="wpush-apikey"
    ...
    <div class="mb-3">
        ...
        <select
            id="wpush-channel"
            v-model="$parent.notification.wpushChannel"
            class="form-select"
            required
        >
    ...
    <i18n-t tag="p" keypath="More info on:">
        <a href="https://wpush.cn/" rel="noopener noreferrer" target="_blank"
            >https://wpush.cn/</a
        >
    </i18n-t>
</template>
