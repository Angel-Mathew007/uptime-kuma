<template>
    <div class="mb-3">
        <label for="pushdeer-server" class="form-label">{{
            $t("PushDeer Server URL")
        }}</label>
        <input
            id="pushdeer-server"
    ...
    <div class="mb-3">
        <label for="pushdeer-key" class="form-label">{{
            $t("PushDeer Key")
        }}</label>
        <HiddenInput
            id="pushdeer-key"
    ...
    <i18n-t tag="p" keypath="More info on:" style="margin-top: 8px">
        <a
            href="http://www.pushdeer.com/"
            rel="noopener noreferrer"
            target="_blank"
            >http://www.pushdeer.com/</a
        >
    </i18n-t>
</template>
