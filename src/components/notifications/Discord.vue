<template>
    <div class="mb-3">
        <label for="discord-webhook-url" class="form-label">{{
    ...
    <div class="mb-3">
        <label for="discord-prefix-message" class="form-label">{{
    ...
    <div class="mb-3">
        <label for="discord-message-type" class="form-label">{{
            $t("Select message type")
        }}</label>
        <select
            id="discord-message-type"
            v-model="$parent.notification.discordChannelType"
            class="form-select"
        >
            <option value="channel">{{ $t("Send to channel") }}</option>
            <option value="createNewForumPost">
                {{ $t("Create new forum post") }}
            </option>
            <option value="postToThread">
    ...
    <div
        v-if="$parent.notification.discordChannelType === 'createNewForumPost'"
    >
        <div class="mb-3">
            ...
            <div class="form-text">
                {{
                    $t("whatHappensAtForumPost", {
                        option: $t("postToExistingThread"),
                    })
                }}
            </div>
        </div>
    ...
    <div v-if="$parent.notification.discordChannelType === 'postToThread'">
        <div class="mb-3">
            ...
            <input
                ...
                autocomplete="false"
                :placeholder="
                    $t('e.g. {discordThreadID}', {
                        discordThreadID: 1177566663751782411,
                    })
                "
            />
            <div class="form-text">
    ...
    <div class="mb-3">
        <div class="form-check form-switch">
            <input
                ...
                role="switch"
            />
            <label class="form-check-label" for="discord-disable-url">{{
