<template>
    <div class="mb-3">
        <label for="telegram-bot-token" class="form-label">{{
            $t("Bot Token")
        }}</label>
        <HiddenInput
    ...
    <div class="mb-3">
        ...
        <label for="message_thread_id" class="form-label">{{
        ...
        <input
            id="server_url"
            v-model="$parent.notification.telegramServerUrl"
            type="text"
            class="form-control"
        />
        <div class="form-text">
            <i18n-t keypath="telegramServerUrlDescription">
                <a
                    ...
                    >{{ $t("here") }}</a
                >
                <a href="https://api.telegram.org" target="_blank"
    ...
    <div class="mb-3">
        <div class="form-check form-switch">
            <input
                v-model="$parent.notification.telegramUseTemplate"
    ...
    <template v-if="$parent.notification.telegramUseTemplate">
        <div class="mb-3">
            <label class="form-label" for="message_parse_mode">{{
                $t("Message Format")
            }}</label>
            <select
            ...
            <i18n-t
                tag="p"
                keypath="telegramTemplateFormatDescription"
                class="form-text"
            >
                <a
            ...
            <label class="form-label" for="message_template">{{
                $t("Message Template")
            }}</label>
            <TemplatedTextarea
                id="message_template"
    ...
    <div class="mb-3">
        <div class="form-check form-switch">
            <input
                v-model="$parent.notification.telegramSendSilently"
                class="form-check-input"
                type="checkbox"
            />
            <label class="form-check-label">{{
    ...
    <div class="mb-3">
        <div class="form-check form-switch">
            <input
                v-model="$parent.notification.telegramProtectContent"
                class="form-check-input"
                type="checkbox"
            />
            <label class="form-check-label">{{
...
{{ msg }}
    ...
    mounted() {
        this.$parent.notification.telegramServerUrl ||=
        ...
        async autoGetTelegramChatID() {
            try {
                let res = await axios.get(
                    this.telegramGetUpdatesURL("withToken"),
                );
