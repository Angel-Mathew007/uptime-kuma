<template>
    <div class="mb-3">
        ...
        <i18n-t
            tag="div"
            keypath="wayToGetPagerTreeIntegrationURL"
            class="form-text"
        >
            <a
    ...
    <div class="mb-3">
        <label for="pagertree-urgency" class="form-label">{{
            $t("pagertreeUrgency")
        }}</label>
        <select
            id="pagertree-urgency"
            v-model="$parent.notification.pagertreeUrgency"
            class="form-select"
        >
    ...
    <div class="mb-3">
        <label for="pagertree-resolve" class="form-label">{{
            $t("pagertreeResolve")
        }}</label>
        <select
            id="pagertree-resolve"
            v-model="$parent.notification.pagertreeAutoResolve"
            class="form-select"
        >
            <option value="resolve" selected="selected">
                {{ $t("pagertreeResolve") }}
            </option>
