<template>
    <div class="mb-3">
        <label for="promosms-login" class="form-label">{{
            $t("promosmsLogin")
        }}</label>
        <input
            id="promosms-login"
            ...
            required
        />
        <label for="promosms-key" class="form-label">{{
            $t("promosmsPassword")
        }}</label>
        <HiddenInput
            id="promosms-key"
    ...
    <div class="mb-3">
        <label for="promosms-type-sms" class="form-label">{{
            $t("SMS Type")
        }}</label>
        <select
            id="promosms-type-sms"
            v-model="$parent.notification.promosmsSMSType"
            class="form-select"
        >
        ...
        <div class="form-text">
            ...
            <a href="https://promosms.com/cennik/" target="_blank"
                >https://promosms.com/cennik/</a
            >
        </div>
    </div>
    <div class="mb-3">
        <label for="promosms-phone-number" class="form-label">{{
    ...
    <div class="mb-3">
        <label for="promosms-sender-name" class="form-label">{{
            $t("promosmsSMSSender")
        }}</label>
        <input
    ...
    <div class="form-check form-switch">
        ...
        />
        <label for="promosms-allow-long" class="form-label">{{
