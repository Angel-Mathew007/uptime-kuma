        ...
        <div class="form-text">
            ...
            <i18n-t tag="p" keypath="aboutWebhooks" style="margin-top: 8px">
                <a
                    ...
                    target="_blank"
                    >https://developers.google.com/chat/how-tos/webhooks</a
                >
            </i18n-t>
        </div>
    </div>
    ...
    <div class="mb-3">
        <div class="form-check form-switch">
            ...
            <i18n-t
                tag="p"
                class="form-text"
                keypath="issueWithGoogleChatOnAndroidHelptext"
            >
                <template #issuetackerURL>
                    <a
                        href="https://issuetracker.google.com/issues/283746283"
                        target="_blank"
                        >issuetracker.google.com/issues/283746283</a
                    >
                </template>
            </i18n-t>
        </div>
