<template>
    <div class="mb-3">
        <label for="brevo-api-key" class="form-label">{{
            $t("brevoApiKey")
        }}</label>
        <HiddenInput
            id="brevo-api-key"
        ...
        <i18n-t tag="div" keypath="brevoApiHelp" class="form-text">
            <a href="https://app.brevo.com/settings/keys/api" target="_blank"
                >https://app.brevo.com/settings/keys/api</a
            >
        </i18n-t>
    </div>
    <div class="mb-3">
        <label for="brevo-from-email" class="form-label">{{
            $t("brevoFromEmail")
        }}</label>
        <input
            id="brevo-from-email"
    ...
    <div class="mb-3">
        <label for="brevo-from-name" class="form-label">{{
            $t("brevoFromName")
        }}</label>
        <input
            id="brevo-from-name"
            v-model="$parent.notification.brevoFromName"
            type="text"
            class="form-control"
        />
    ...
    <div class="mb-3">
        <label for="brevo-to-email" class="form-label">{{
            $t("brevoToEmail")
        }}</label>
        <input
            id="brevo-to-email"
    ...
    <div class="mb-3">
        <label for="brevo-cc-email" class="form-label">{{
            $t("brevoCcEmail")
        }}</label>
        <input
            id="brevo-cc-email"
            v-model="$parent.notification.brevoCcEmail"
            type="text"
            class="form-control"
        />
    ...
    <div class="mb-3">
        <label for="brevo-bcc-email" class="form-label">{{
            $t("brevoBccEmail")
        }}</label>
        <input
            id="brevo-bcc-email"
            v-model="$parent.notification.brevoBccEmail"
            type="text"
            class="form-control"
        />
    ...
    <div class="mb-3">
        <label for="brevo-subject" class="form-label">{{
            $t("brevoSubject")
        }}</label>
        <input
            id="brevo-subject"
            v-model="$parent.notification.brevoSubject"
            type="text"
            class="form-control"
        />
        <small class="form-text text-muted">{{
    ...
    <i18n-t tag="p" keypath="More info on:" style="margin-top: 8px">
        <a
            ...
            target="_blank"
            >https://developers.brevo.com/reference/sendtransacemail</a
        >
    </i18n-t>
</template>
...
export default {
    ...
    mounted() {
        if (typeof this.$parent.notification.brevoSubject === "undefined") {
            this.$parent.notification.brevoSubject =
