<template>
    <div class="mb-3">
        <label for="evolution-instance-name" class="form-label">{{
    ...
    <div class="mb-3">
        <label for="evolution-api-url" class="form-label">{{
            $t("API URL")
        }}</label>
        <input
    ...
    <div class="mb-3">
        <label for="evolution-auth-token" class="form-label">{{
            $t("Token")
        }}</label>
        <HiddenInput
        ...
        <i18n-t
            tag="div"
            keypath="wayToGetEvolutionUrlAndToken"
            class="form-text"
        >
            <a href="https://evoapicloud.com" target="_blank"
                >https://evoapicloud.com</a
            >
        </i18n-t>
    </div>

    <div class="mb-3">
        <label for="evolution-recipient" class="form-label">{{
            $t("evolutionRecipient")
        }}</label>
        <input
