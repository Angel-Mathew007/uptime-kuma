<template>
    <div class="mb-3">
        <label for="clicksendsms-login" class="form-label">{{
            $t("API Username")
        }}</label>
        ...
        <input
            ...
            required
        />
        <label for="clicksendsms-key" class="form-label">{{
            $t("API Key")
        }}</label>
        <HiddenInput
            id="clicksendsms-key"
    ...
    <div class="mb-3">
        <div class="form-text">
            ...
            <a href="https://www.clicksend.com/us/pricing" target="_blank"
                >https://clicksend.com/us/pricing</a
            >
        </div>
    </div>
    <div class="mb-3">
        <label for="clicksendsms-to-number" class="form-label">{{
            $t("Recipient Number")
        }}</label>
        <input
