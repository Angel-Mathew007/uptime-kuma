<template>
    <div class="mb-3">
        ...
        <input
            ...
            required
        />
        <label for="slack-username" class="form-label">{{
            $t("Username")
        }}</label>
        <input
            id="slack-username"
            v-model="$parent.notification.slackusername"
            type="text"
            class="form-control"
        />
        <div class="form-text">
        ...
        <label for="slack-iconemo" class="form-label">{{
            $t("Icon Emoji")
        }}</label>
        <input
            id="slack-iconemo"
            v-model="$parent.notification.slackiconemo"
            type="text"
            class="form-control"
        />
        <label for="slack-channel" class="form-label">{{
            $t("Channel Name")
        }}</label>
        <input
            id="slack-channel-name"
            v-model="$parent.notification.slackchannel"
            type="text"
            class="form-control"
        />
        ...
        <div class="form-check form-switch">
            ...
            />
            <label for="slack-text-message" class="form-label">{{
        ...
        <div class="form-text">
            ...
            <i18n-t tag="p" keypath="aboutWebhooks" style="margin-top: 8px">
                <a
                    ...
                    target="_blank"
                    >https://api.slack.com/messaging/webhooks</a
                >
            </i18n-t>
            ...
            <i18n-t tag="p" keypath="emojiCheatSheet" style="margin-top: 8px">
                <a
                    ...
                    target="_blank"
                    >https://www.webfx.com/tools/emoji-cheat-sheet/</a
                >
            </i18n-t>
        </div>
        ...
        <div class="form-check form-switch">
            <input
                ...
                class="form-check-input"
            />
            <label for="slack-channel-notify" class="form-label">{{
                $t("Notify Channel")
            }}</label>
        </div>
        <div class="form-text">
