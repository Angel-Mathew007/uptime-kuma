<template>
    <div class="mb-3">
        <label for="Bark API Version" class="form-label">{{
            $t("Bark API Version")
        }}</label>
        <select
            id="Bark API Version"
            v-model="$parent.notification.apiVersion"
            class="form-select"
            required
        >
    ...
    <div class="mb-3">
        ...
        <i18n-t tag="div" keypath="wayToGetTeamsURL" class="form-text">
            <a href="https://github.com/Finb/Bark" target="_blank">{{
                $t("here")
            }}</a>
        </i18n-t>
    </div>
    <div class="mb-3">
        <label for="Bark Group" class="form-label">{{
            $t("Bark Group")
        }}</label>
        <input
            id="Bark Group"
            v-model="$parent.notification.barkGroup"
            type="text"
            class="form-control"
            required
        />
    ...
    <div class="mb-3">
        <label for="Bark Sound" class="form-label">{{
            $t("Bark Sound")
        }}</label>
        <select
            id="Bark Sound"
            v-model="$parent.notification.barkSound"
            class="form-select"
            required
        >
