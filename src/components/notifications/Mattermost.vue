<template>
    <div class="mb-3">
        ...
        <input
            ...
            required
        />
        <label for="mattermost-username" class="form-label">{{
            $t("Username")
        }}</label>
        <input
            ...
            class="form-control"
        />
        <label for="mattermost-iconurl" class="form-label">{{
            $t("Icon URL")
        }}</label>
        <input
            ...
            class="form-control"
        />
        <label for="mattermost-iconemo" class="form-label">{{
            $t("Icon Emoji")
        }}</label>
        <input
            ...
            class="form-control"
        />
        <label for="mattermost-channel" class="form-label">{{
            $t("Channel Name")
        }}</label>
        <input
        ...
        <div class="form-text">
            ...
            <i18n-t tag="p" keypath="aboutWebhooks" style="margin-top: 8px">
                <a
                    ...
                    target="_blank"
                    >https://developers.mattermost.com/integrate/webhooks/incoming/</a
                >
            </i18n-t>
