<template>
    <div class="mb-3">
        <label for="smspartner-key" class="form-label">{{
            $t("API Key")
        }}</label>
        <HiddenInput
            id="smspartner-key"
        ...
        <div class="form-text">
            <i18n-t keypath="smspartnerApiurl" tag="div" class="form-text">
                <a href="https://my.smspartner.fr/dashboard/api" target="_blank"
                    >my.smspartner.fr/dashboard/api</a
                >
            </i18n-t>
        </div>
    </div>
    <div class="mb-3">
        <label for="smspartner-phone-number" class="form-label">{{
            $t("smspartnerPhoneNumber")
        }}</label>
        <input
        ...
        <div class="form-text">
            <i18n-t
                keypath="smspartnerPhoneNumberHelptext"
                tag="div"
                class="form-text"
            >
    ...
    <div class="mb-3">
        <label for="smspartner-sender-name" class="form-label">{{
            $t("smspartnerSenderName")
        }}</label>
        <input
