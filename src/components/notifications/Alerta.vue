<template>
    <div class="mb-3">
        <label for="alerta-api-endpoint" class="form-label">{{
            $t("alertaApiEndpoint")
        }}</label>
        <input
            ...
            required
        />
        <label for="alerta-environment" class="form-label">{{
            $t("alertaEnvironment")
        }}</label>
        <input
            ...
            required
        />
        <label for="alerta-api-key" class="form-label">{{
            $t("alertaApiKey")
        }}</label>
        <input
            id="alerta-api-key"
            ...
            required
        />
        <label for="alerta-alert-state" class="form-label">{{
            $t("alertaAlertState")
        }}</label>
        <input
            ...
            required
        />
        <label for="alerta-recover-state" class="form-label">{{
            $t("alertaRecoverState")
        }}</label>
        <input
