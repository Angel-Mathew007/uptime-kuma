<template>
    <div class="mb-3">
        <label for="bitrix24-webhook-url" class="form-label">{{
            $t("Bitrix24 Webhook URL")
        }}</label>
        <HiddenInput
        ...
        <i18n-t tag="div" keypath="wayToGetBitrix24Webhook" class="form-text">
            <a
                ...
                target="_blank"
                >https://helpdesk.bitrix24.com/open/12357038/</a
            >
        </i18n-t>
    </div>

    <div class="mb-3">
        <label for="bitrix24-user-id" class="form-label">{{
            $t("User ID")
        }}</label>
        <input
            id="bitrix24-user-id"
