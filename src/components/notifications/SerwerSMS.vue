<template>
    <div class="mb-3">
        <label for="serwersms-username" class="form-label">{{
            $t("serwersmsAPIUser")
        }}</label>
        <input
    ...
    <div class="mb-3">
        <label for="serwersms-key" class="form-label">{{
            $t("serwersmsAPIPassword")
        }}</label>
        <HiddenInput
            id="serwersms-key"
    ...
    <div class="mb-3">
        <label for="serwersms-sender-name" class="form-label">{{
            $t("serwersmsSenderName")
        }}</label>
        <input
