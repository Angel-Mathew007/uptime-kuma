    ...
    <div>
        <div class="dockerHost-list my-4">
            ...
            <ul class="list-group mb-3" style="border-radius: 1rem">
                <li
                    v-for="(remoteBrowser, index) in $root.remoteBrowserList"
                    :key="index"
                ...
                >
                    ...
                    <a
                        href="#"
                        @click="
                            $refs.remoteBrowserDialog.show(remoteBrowser.id)
                        "
                        >{{ $t("Edit") }}</a
                    >
                </li>
            ...
            <button
                ...
                type="button"
                @click="$refs.remoteBrowserDialog.show()"
            >
