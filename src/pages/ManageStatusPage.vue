    ...
    <transition name="slide-fade" appear>
        <div>
            ...
            <div class="shadow-box">
                ...
                <div
                    v-else
                    class="d-flex align-items-center justify-content-center my-3 spinner"
                >
