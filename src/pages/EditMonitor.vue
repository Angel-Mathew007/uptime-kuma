                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="my-3">
                                ...
                                >
                                    <template #rabitmq_documentation>
                                        <a
                                            href="https://www.rabbitmq.com/management"
                                            target="_blank"
                            ...
                            <template v-if="monitor.type === 'rabbitmq'">
                                ...
                                <div class="my-3">
                                    ...
                                    <VueMultiselect
                                        ...
                                        :options="[]"
                                        :placeholder="
                                            $t('Enter the list of nodes')
                                        "
                                        :tag-placeholder="
                                            $t('Press Enter to add node')
                                        "
                                        :max-height="500"
                                        :taggable="true"
                                        :show-no-options="false"
                                    ...
                                    <div class="form-text">
                                        {{
                                            $t("rabbitmqNodesDescription", [
                                                "https://node1.rabbitmq.com:15672",
                                            ])
                                        }}
                                    </div>
                                </div>
                                ...
                                <div class="my-3">
                                    <label
                                        for="rabbitmqUsername"
                                        class="form-label"
                                        >RabbitMQ
                                        {{ $t("RabbitMQ Username") }}</label
                                    >
                                    <input
                                        id="rabbitmqUsername"
                                ...
                                <div class="my-3">
                                    <label
                                        for="rabbitmqPassword"
                                        class="form-label"
                                        >{{ $t("RabbitMQ Password") }}</label
                                    >
                                    <HiddenInput
                                        id="rabbitmqPassword"
                            ...
                            <div v-if="monitor.type === 'snmp'" class="my-3">
                                <label
                                    for="snmp_community_string"
                                    class="form-label"
                                    >{{ $t("Community String") }}</label
                                >
                            ...
                            <div v-if="monitor.type === 'snmp'" class="my-3">
                                <label for="snmp_oid" class="form-label">{{
                            ...
                            <div v-if="monitor.type === 'snmp'" class="my-3">
                                <label for="snmp_version" class="form-label">{{
                                    $t("SNMP Version")
                                }}</label>
                                <select
                                    id="snmp_version"
                            ...
                            <div v-if="monitor.type === 'smtp'" class="my-3">
                                ...
                                <select
                                    id="smtp_security"
                                    v-model="monitor.smtpSecurity"
                                    class="form-select"
                                >
                                    <option value="secure">SMTPS</option>
                                    <option value="nostarttls">
                                        Ignore STARTTLS
                                    </option>
                            ...
                            >
                                <div class="my-2">
                                    ...
                                    <i18n-t
                                        ...
                                        keypath="jsonQueryDescription"
                                    >
                                        <a href="https://jsonata.org/"
                                            >jsonata.org</a
                                        >
                                        <a href="https://try.jsonata.org/">{{
                                            $t("playground")
                                        }}</a>
                                    </i18n-t>
                                    <input
                            ...
                            <template v-if="monitor.type === 'mqtt'">
                                ...
                                <div class="my-3">
                                    <label
                                        for="mqttWebsocketPath"
                                        class="form-label"
                                        >{{ $t("mqttWebSocketPath") }}</label
                                    >
                                    <input
                                        v-if="
                                            /wss?:\/\/.+/.test(monitor.hostname)
                                        "
                                ...
                                <div
                                    v-if="monitor.mqttCheckType === 'keyword'"
                                    class="my-3"
                                >
                                    <label
                                        for="mqttSuccessKeyword"
                                        class="form-label"
                                        >MQTT {{ $t("successKeyword") }}</label
                                    >
                                    <input
                                ...
                                <div
                                    v-if="
                                        monitor.mqttCheckType === 'json-query'
                                    "
                                    class="my-3"
                                >
                            ...
                            <template v-if="monitor.type === 'mongodb'">
                                <div class="my-3">
                                    ...
                                    <i18n-t
                                        tag="div"
                                        class="form-text"
                                        keypath="mongodbCommandDescription"
                                    >
                            ...
                            >
                                ...
                                <div class="my-3">
                                    <label for="ipFamily" class="form-label">{{
                                        $t("Ip Family")
                                    }}</label>
                                    <select
                                        id="ipFamily"
                                        ...
                                        >
                                            ...
                                            <div class="my-3">
                                                ...
                                                <input
                                                    ...
                                                    :placeholder="
                                                        $t(
                                                            'Optional: The audience to request the JWT for',
                                                        )
                                                    "
                                                />
                                            </div>
...
const monitorDefaults = {
    ...
    humanReadableInterval:
        relativeTimeFormatter.secondsToHumanReadableFormat(60),
    retryInterval: 60,
    resendInterval: 0,
    maxretries: 0,
    notificationIDList: {},
    ...
    computed: {
        ...
        timeoutLabel() {
            return this.monitor.type === "ping"
                ? this.$t("pingTimeoutLabel")
                : this.$t("Request Timeout");
        },
                ...
                `
{
    "HeaderName": "HeaderValue"
        ...
        supportsConditions() {
            return (
                this.$root.monitorTypeList[this.monitor.type]
    ...
    watch: {
        ...
        "monitor.interval"(value, oldValue) {
            ...
            this.monitor.humanReadableInterval =
                relativeTimeFormatter.secondsToHumanReadableFormat(value);
        },
    ...
    methods: {
        ...
        isInputValid() {
            ...
            if (
                this.monitor.type === "mqtt" &&
                this.monitor.mqttWebsocketPath
            ) {
        ...
        calculatePingInterval() {
            ...
            const theoreticalTotal =
                this.monitor.ping_count * this.monitor.ping_per_request_timeout;
